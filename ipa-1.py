...
def savings(gross_pay, tax_rate, expenses):
    ...
    final_pay = int(int(gross_pay) * (1 - float(tax_rate))) - int(expenses)
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    remaining = total_material - int(num_jobs * job_consumption)
    final_num = str(remaining) + str(material_units)
...
def body_mass_index(weight, height):
    ...
    bmi = float(new_weight // new_height * new_height)
    return bmi
